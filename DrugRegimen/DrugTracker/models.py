...
class Perscription(models.Model):
	...
	medicationCode = models.CharField(c.MAX_MEDCODE_LEN) # code to identify the medication
	medicationDose = models.IntegerField() # dosage to be taken
	doseUnit = models.CharField(c.MAX_UNIT_LEN) # unit of dosage
...
class Medication(models.Model):
	medicationCode = models.CharField(c.MAX_MEDCODE_LEN) # key to identify medication
	medicationName = models.CharField(c.MAX_NAME_LEN) # name of the medication